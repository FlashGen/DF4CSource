package com.developingcomponents.components
{
	...
	public class UIComponentTemplateExample extends UIComponent
	{
		...
		[Bindable]
		[ArrayElementType("spark.components.Button")]
		public var controlBar       :Array;
		
		public function UIComponentTemplateExample()
		{
			super();
		...
		{     
			...
			{
				_controlBar.addElement(controlBar[i]); 
			}       
		}
